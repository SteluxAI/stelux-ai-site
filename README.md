...
Dark, depth-driven marketing site for [stelux.ai](https://stelux.ai): 3-layer parallax hero (0.3x / 1.0x / 1.4x), fora-style stacking feature cards, an interactive CLI/SDK showcase, live-feel telemetry, an access matrix and a minimalist footer.
